...
namespace Examples.Expressions.Eval.LINQ_Dynamic.Join_Operators
{
    public partial class CrossJoinwithGroupJoin : Form
    {
        ...
        private void uiCrossJoinwithGroupJoin_LINQ_Dynamic_Click(object sender, EventArgs e)
        {
        ...
        private void uiCrossJoinwithGroupJoin_LINQ_Click(object sender, EventArgs e)
        {
            ...
            var q = from c in categories   join p in products on c equals p.Category into ps   from p in ps   select new { Category = c, p.ProductName };
