...
namespace Examples.Expressions.Eval.LINQ_Dynamic.Join_Operators
{
    public partial class CrossJoin : Form
    {
        ...
        private void uiCrossJoin_LINQ_Click(object sender, EventArgs e)
        {
        ...
        private void uiCrossJoin_LINQ_Dynamic_Click(object sender, EventArgs e)
        {

        }

        private void uiCrossJoin_LINQ_Execute_Click(object sender, EventArgs e)
        {
